...
#     "offset": FACTOR*10,
#     "wall": [FACTOR*(FIELD_DIMENSIONS["A"]+2*FIELD_DIMENSIONS["L"]), FACTOR*(FIELD_DIMENSIONS["B"]+2*FIELD_DIMENSIONS["L"])],
#     "outerLine": [FACTOR*FIELD_DIMENSIONS["A"], FACTOR*FIELD_DIMENSIONS["B"]],
...
SMALLFONT = pygame.font.SysFont('segoeuiemoji', int(4*(FACTOR)))
TINYFONT = pygame.font.SysFont('segoeuiemoji', int(3*(FACTOR)))
SUPERTINYFONT = pygame.font.SysFont('segoeuiemoji', int(2*(FACTOR)))
