...
class Robot:
    ...
    def draw_robotInfo1(self, Robots, selectedRobot = -1):
        robotID = self.robotID - 1

        textTemp = pygame.Surface((int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS), consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1]))
        ...
        for robot in Robots:
            if selectedRobot != -1:
                ...
                pygame.draw.rect(consts.SCREEN,consts.COLORS["button"],((robot.robotID-1) * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS), consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1],int(consts.RESOLUTION[0] /consts.NUMBER_OF_ROBOTS) -consts.FACTOR, consts.RESOLUTION[1] - consts.MENUS_SIZE * consts.RESOLUTION[1] - consts.FIELD_SIZE["wall"][1],),border_radius=5,)
        
        width, height = consts.SMALLFONT.size(" ")
        ...
        string8 = ""
        for robot in Robots:
            string1 += " \U0001F916 " + str(robot.robotID) + "    "
            if robot.battery > 0:
                if robot.battery < 15:
                    emoji = "\U0001FAAB"
                    ...
                    emoji = "\U0001F50B"
                string1 += emoji + str(robot.battery) + "%"
            else:
                string1 += emoji + "Not Conn."
            
            string1 += "   "    
            
            if robot.battery12 > 0:
                if robot.battery12 < 15:
                    emoji = "\U0001FAAB"
                elif robot.battery12 < 30:
                    emoji = "\U0001F50B"
                else:
                    emoji = "\U0001F50B"
                string1 += "\U0001F4F7" + emoji + str(robot.battery12) + "%"
            else:
                string1 += "\U0001F4F7" + emoji + "Not Conn."
            
            string1 += "   "
            
            if abs(robot.pcbattery) < 15:
                emoji = "\U0001FAAB"
            elif abs(robot.pcbattery) < 30:
                emoji = "\U0001F50B"
            else:
                emoji = "\U0001F50B"
            if robot.pcbattery > 0:
                string1 += "\U0001F4BB" + emoji + str(robot.battery) + "%" + "\U0001F50C"
            else:
                string1 += "\U0001F4BB" + emoji + str(abs(self.pcbattery)) + "%"
            
            string1 += spaceCalculator(string1, robot.robotID, width)
            
            string2 += " \U0001F30D " + str(round(robot.position[0], 2)) + " " + str(round(robot.position[1], 2)) + " " + str(robot.position[2]) + "       " + "\U000026BD " + str(round(robot.ball_position[0], 2)) + " " + str(round(robot.ball_position[1], 2)) + " " + str(robot.ball_handler)
            string2 += spaceCalculator(string2, robot.robotID, width)
            
            string3 += " \U0001F4E9 " + consts.SKILLSGUI[robot.packet[0]] + " " + str(robot.packet[1:]) + "   |   \U000023F1: " + str(robot.dt)
            string3 += spaceCalculator(string3, robot.robotID, width)
            
            string4 += "\U0001F4F6 " + str(self.QC1) + "% | " + str(self.ID) + "/128" + "  |  FPS: " + str(self.fps) + "         " + " Git \U00002601 : " + str(self.commit)
            string4 += spaceCalculator(string4, robot.robotID, width)
            
            string5 += " CPU \U0001F532 :" + str(self.cpu) + "% \U0001F321: " + str(self.cpuTemp) + "ºC    |    GPU : " + str(self.gpu) + "% \U0001F321: " + str(self.gpuTemp) + "ºC"
            string5 += spaceCalculator(string5, robot.robotID, width)
            
            string6 += " OMNI - \U000023EB:" + str(self.linear_vel) + "  \U0001F504:" + str(self.angular_vel) + "  \U00002199:" + str(self.direction) + " \U0001F321: " + str(self.OMNI_temp) + "ºC"
            string6 += spaceCalculator(string6, robot.robotID, width)
        
            string7 += " Dribbler - \U00002197  " + str(self.disp_db_l) + "  v-> " + str(self.vel_db_l) + "  \U0001F94E  " + str(self.vel_db_l) + " <-v  " + str(self.disp_db_r) + "  \U00002196"
            string7 += spaceCalculator(string7, robot.robotID, width)
        
            string8 += " \U0001F9BF\U0001F3C8: " + str(self.Cap) + " %"
            string8 += spaceCalculator(string8, robot.robotID, width)
            
        text = consts.SMALLFONT.render(string1, True, (255, 255, 255))
        consts.SCREEN.blit(text,(2 * consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR,),)
        text = consts.SMALLFONT.render(string2, True, (255, 255, 255))
        consts.SCREEN.blit(text,(2 * consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 8 *consts.FACTOR,),)
        text = consts.SMALLFONT.render(string3, True, (255, 255, 255))
        consts.SCREEN.blit(text,(2 * consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 14 *consts.FACTOR,),)
        text = consts.SMALLFONT.render(string4, True, (255, 255, 255))
        consts.SCREEN.blit(text,(2 * consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 20 *consts.FACTOR,),)
        text = consts.SMALLFONT.render(string5, True, (255, 255, 255))
        consts.SCREEN.blit(text,(2 * consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 26 *consts.FACTOR,),)
        text = consts.SMALLFONT.render(string6, True, (255, 255, 255))
        consts.SCREEN.blit(text,(2 * consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 32 *consts.FACTOR,),)
        text = consts.SMALLFONT.render(string7, True, (255, 255, 255))
        consts.SCREEN.blit(text,(2 * consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 38 *consts.FACTOR,),)
        text = consts.SMALLFONT.render(string8, True, (255, 255, 255))
        consts.SCREEN.blit(text,(2 * consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 44 *consts.FACTOR,),)
    ...
    def draw_robotInfo2(self, selectedRobot = 0):
        robotID = self.robotID - 1
        ...
        text = consts.SMALLFONT.render("\U0001F916 " + str(self.robotID), True, (255, 255, 255)).convert_alpha()
        consts.SCREEN.blit(text,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS) + 2 * consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR,),)

        if self.battery < 0:
            cor = consts.COLORS["pink"]
            emoji = "\U0001FAAB"
            text = consts.SMALLFONT.render(emoji+ str("NOT CON."), True, cor).convert_alpha()
        else:
            if self.battery < 15:
                cor = consts.COLORS["batRed"]
                emoji = "\U0001FAAB"
                ...
                cor = consts.COLORS["white"]
                emoji = "\U0001F50B"
            text = consts.SMALLFONT.render(emoji+ str(self.battery) + "%", True, cor).convert_alpha()
        ...
        if self.battery12 < 0:
            ...
            if self.battery12 < 15:
                ...
                cor = consts.COLORS["white"]
                emoji = "\U0001F50B"
            text = consts.SMALLFONT.render(str("\U0001F4F7")+emoji+ str(self.battery12) + "%", True, cor).convert_alpha()
        consts.SCREEN.blit(text,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS) + int(5*int(consts.RESOLUTION[0]/consts.NUMBER_OF_ROBOTS)/12), consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR,),)
        ...
        if abs(self.pcbattery) < 15:
            ...
            emoji = "\U0001F50B"
        if self.pcbattery > 0:
            text = consts.SMALLFONT.render("\U0001F4BB"+emoji+ str(abs(self.pcbattery)) + "%" + "\U0001F50C", True, cor).convert_alpha()
        else:
            text = consts.SMALLFONT.render("\U0001F4BB"+emoji+ str(abs(self.pcbattery)) + "%", True, cor).convert_alpha()
        consts.SCREEN.blit(text,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS) + int(7*int(consts.RESOLUTION[0]/consts.NUMBER_OF_ROBOTS)/10), consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR,),)

        text = consts.SMALLFONT.render("\U0001F30D " + str(round(self.position[0], 2)) + " " + str(round(self.position[1], 2)) + " " + str(self.position[2]), True, (255, 255, 255)).convert_alpha()
        consts.SCREEN.blit(text,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS) + 2 * consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR + 6 *consts.FACTOR,),)
        text = consts.SMALLFONT.render("\U000026BD " + str(round(self.ball_position[0], 2)) + " " + str(round(self.ball_position[1], 2)) + " " + str(self.ball_handler), True, (255, 255, 255)).convert_alpha()
        consts.SCREEN.blit(text,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS) + 35 * consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR + 6 *consts.FACTOR,),)
        text = consts.SMALLFONT.render("\U0001F4E9 " + consts.SKILLSGUI[self.packet[0]] + " " + str(self.packet[1:]) + "   |   \U000023F1: " + str(self.dt), True, (255, 255, 255)).convert_alpha()
        consts.SCREEN.blit(text,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS) + 2 * consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR + 12 *consts.FACTOR,),)
        text = consts.SMALLFONT.render("\U0001F4F6 " + str(self.QC1) + "% | " + str(self.ID) + "/128" + "  |  FPS: " + str(self.fps), True, (255, 255, 255)).convert_alpha()
        consts.SCREEN.blit(text,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS)+ 2 * consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR + 18 *consts.FACTOR,),)
        text = consts.SMALLFONT.render(" Git \U00002601 : " + str(self.commit), True, (255, 255, 255)).convert_alpha()
        consts.SCREEN.blit(text,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS)+ 20 * consts.FACTOR+ 21*consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR + 18.4 *consts.FACTOR,),)
        text = consts.SMALLFONT.render(" CPU \U0001F532 :" + str(self.cpu) + "% \U0001F321: " + str(self.cpuTemp) + "ºC    |    GPU : " + str(self.gpu) + "% \U0001F321: " + str(self.gpuTemp) + "ºC", True, (255, 255, 255)).convert_alpha()
        consts.SCREEN.blit(text,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS)+ 2 * consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR + 24 *consts.FACTOR,),)
        
        text = consts.SMALLFONT.render("OMNI - \U000023EB:" + str(self.linear_vel) + "  \U0001F504:" + str(self.angular_vel) + "  \U00002199:" + str(self.direction) + " \U0001F321: " + str(self.OMNI_temp) + "ºC", True, (255, 255, 255)).convert_alpha()
        consts.SCREEN.blit(text,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS)+ 2 * consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR + 30 *consts.FACTOR,),)
        text = consts.SMALLFONT.render("Dribbler - \U00002197  " + str(self.disp_db_l) + "  v-> " + str(self.vel_db_l) + "  \U0001F94E  " + str(self.vel_db_l) + " <-v  " + str(self.disp_db_r) + "  \U00002196", True, (255, 255, 255)).convert_alpha()
        consts.SCREEN.blit(text,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS)+ 2 * consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR + 36 *consts.FACTOR,),)
         
        text = consts.SMALLFONT.render("\U0001F9BF\U0001F3C8: " + str(self.Cap) + " %", True, (255, 255, 255)).convert_alpha()
        consts.SCREEN.blit(text,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS)+ 2 * consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR + 42 *consts.FACTOR,),)
        
        
    def draw_robotInfo5(self, selectedRobot = 0):
        robotID = self.robotID - 1
        ...
        # text = consts.SMALLFONT.render("\U0001F916 " + str(self.robotID), True, (255, 255, 255))
        consts.SMALLFONT.render_to(consts.SCREEN,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS) + 2 * consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR,),"\U0001F916 " + str(self.robotID), (255, 255, 255))

        consts.SMALLFONT.render_to(consts.SCREEN,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS) + int(int(consts.RESOLUTION[0]/consts.NUMBER_OF_ROBOTS)/6) + 2 * consts.FACTOR, consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR,), str(self.battery) + "%", (255,255,255))

        consts.SMALLFONT.render_to(consts.SCREEN,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS) + int(5*int(consts.RESOLUTION[0]/consts.NUMBER_OF_ROBOTS)/12), consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR,),str(self.battery12) + "%", (255, 255, 255))
        ...
        if abs(self.pcbattery) < 15:
            ...
            emoji = "\U0001F50B"
        if self.pcbattery > 0:
            text = ""+ str(abs(self.pcbattery)) + "%" + ""
        else:
            text = ""+ str(abs(self.pcbattery)) + "%"
        consts.SMALLFONT.render_to(consts.SCREEN,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS) + int(7*int(consts.RESOLUTION[0]/consts.NUMBER_OF_ROBOTS)/10), consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR,),text, (255, 255, 255))

        # text = consts.SMALLFONT.render("\U0001F30D " + str(round(self.position[0], 2)) + " " + str(round(self.position[1], 2)) + " " + str(self.position[2]), True, (255, 255, 255))
        consts.SMALLFONT.render_to(consts.SCREEN,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS) + 2 * consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR + 6 *consts.FACTOR,)," " + str(round(self.position[0], 2)) + " " + str(round(self.position[1], 2)) + " " + str(self.position[2]), (255, 255, 255))
        # text = consts.SMALLFONT.render("\U000026BD " + str(round(self.ball_position[0], 2)) + " " + str(round(self.ball_position[1], 2)) + " " + str(self.ball_handler), True, (255, 255, 255))
        consts.SMALLFONT.render_to(consts.SCREEN,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS) + 35 * consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR + 6 *consts.FACTOR,)," " + str(round(self.ball_position[0], 2)) + " " + str(round(self.ball_position[1], 2)) + " " + str(self.ball_handler), (255, 255, 255))
        # text = consts.SMALLFONT.render("\U0001F4E9 " + consts.SKILLSGUI[self.packet[0]] + " " + str(self.packet[1:]) + "   |   \U000023F1: " + str(self.dt), True, (255, 255, 255))
        consts.SMALLFONT.render_to(consts.SCREEN,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS) + 2 * consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR + 12 *consts.FACTOR,)," " + consts.SKILLSGUI[self.packet[0]] + " " + str(self.packet[1:]) + "   |   : " + str(self.dt), (255, 255, 255))
        # text = consts.SMALLFONT.render("\U0001F4F6 " + str(self.QC1) + "% | " + str(self.ID) + "/128" + "  |  FPS: " + str(self.fps), True, (255, 255, 255))
        consts.SMALLFONT.render_to(consts.SCREEN,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS)+ 2 * consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR + 18 *consts.FACTOR,)," " + str(self.QC1) + "% | " + str(self.ID) + "/128" + "  |  FPS: " + str(self.fps), (255, 255, 255))
        # text = consts.SMALLFONT.render(" Git \U00002601 : " + str(self.commit), True, (255, 255, 255))
        consts.SMALLFONT.render_to(consts.SCREEN,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS)+ 20 * consts.FACTOR+ 21*consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR + 18.4 *consts.FACTOR,)," Git  : " + str(self.commit), (255, 255, 255))
        # text = consts.SMALLFONT.render(" CPU \U0001F532 :" + str(self.cpu) + "% \U0001F321: " + str(self.cpuTemp) + "ºC    |    GPU : " + str(self.gpu) + "% \U0001F321: " + str(self.gpuTemp) + "ºC", True, (255, 255, 255))
        consts.SMALLFONT.render_to(consts.SCREEN,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS)+ 2 * consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR + 24 *consts.FACTOR,)," CPU  :" + str(self.cpu) + "% : " + str(self.cpuTemp) + "ºC    |    GPU : " + str(self.gpu) + "% : " + str(self.gpuTemp) + "ºC", (255, 255, 255))
        
        # text = consts.SMALLFONT.render("OMNI - \U000023EB:" + str(self.linear_vel) + "  \U0001F504:" + str(self.angular_vel) + "  \U00002199:" + str(self.direction) + " \U0001F321: " + str(self.OMNI_temp) + "ºC", True, (255, 255, 255))
        consts.SMALLFONT.render_to(consts.SCREEN,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS)+ 2 * consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR + 30 *consts.FACTOR,),"OMNI - :" + str(self.linear_vel) + "  :" + str(self.angular_vel) + "  :" + str(self.direction) + " : " + str(self.OMNI_temp) + "ºC", (255, 255, 255))
        # text = consts.SMALLFONT.render("Dribbler - \U00002197  " + str(self.disp_db_l) + "  v-> " + str(self.vel_db_l) + "  \U0001F94E  " + str(self.vel_db_l) + " <-v  " + str(self.disp_db_r) + "  \U00002196", True, (255, 255, 255))
        consts.SMALLFONT.render_to(consts.SCREEN,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS)+ 2 * consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR + 36 *consts.FACTOR,),"Dribbler -   " + str(self.disp_db_l) + "  v-> " + str(self.vel_db_l) + "    " + str(self.vel_db_l) + " <-v  " + str(self.disp_db_r) + "  ", (255, 255, 255))
         
        # text = consts.SMALLFONT.render("\U0001F9BF\U0001F3C8: " + str(self.Cap) + " %", True, (255, 255, 255))
        consts.SMALLFONT.render_to(consts.SCREEN,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS)+ 2 * consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR + 42 *consts.FACTOR,),": " + str(self.Cap) + " %", (255, 255, 255))
        
        
        
    def draw_robotInfo4(self, selectedRobot = 0):
        robotID = self.robotID - 1
        ...
        consts.SMALLFONT.render_to(consts.SCREEN,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS) + int(int(consts.RESOLUTION[0]/consts.NUMBER_OF_ROBOTS)/6) + 2 * consts.FACTOR, consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR,),emoji+ str(self.battery) + "%", (255,255,255))
        ...
        if self.battery12 < 0:
            ...
            if self.battery12 < 15:
                ...
                emoji = "\U0001F50B"
            # text = consts.SMALLFONT.render(str("\U0001F4F7")+emoji+ str(self.battery12) + "%", True, cor)
        consts.SMALLFONT.render_to(consts.SCREEN,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS) + int(5*int(consts.RESOLUTION[0]/consts.NUMBER_OF_ROBOTS)/12), consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR,),str("\U0001F4F7")+emoji+ str(self.battery12) + "%", (255, 255, 255))
        ...
        if abs(self.pcbattery) < 15:
            ...
            emoji = "\U0001F50B"
        if self.pcbattery > 0:
            text = "\U0001F4BB"+emoji+ str(abs(self.pcbattery)) + "%" + "\U0001F50C"
        else:
            text = "\U0001F4BB"+emoji+ str(abs(self.pcbattery)) + "%"
        consts.SMALLFONT.render_to(consts.SCREEN,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS) + int(7*int(consts.RESOLUTION[0]/consts.NUMBER_OF_ROBOTS)/10), consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR,),text, (255, 255, 255))

        # text = consts.SMALLFONT.render("\U0001F30D " + str(round(self.position[0], 2)) + " " + str(round(self.position[1], 2)) + " " + str(self.position[2]), True, (255, 255, 255))
        consts.SMALLFONT.render_to(consts.SCREEN,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS) + 2 * consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR + 6 *consts.FACTOR,),"\U0001F30D " + str(round(self.position[0], 2)) + " " + str(round(self.position[1], 2)) + " " + str(self.position[2]), (255, 255, 255))
        # text = consts.SMALLFONT.render("\U000026BD " + str(round(self.ball_position[0], 2)) + " " + str(round(self.ball_position[1], 2)) + " " + str(self.ball_handler), True, (255, 255, 255))
        consts.SMALLFONT.render_to(consts.SCREEN,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS) + 35 * consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR + 6 *consts.FACTOR,),"\U000026BD " + str(round(self.ball_position[0], 2)) + " " + str(round(self.ball_position[1], 2)) + " " + str(self.ball_handler), (255, 255, 255))
        # text = consts.SMALLFONT.render("\U0001F4E9 " + consts.SKILLSGUI[self.packet[0]] + " " + str(self.packet[1:]) + "   |   \U000023F1: " + str(self.dt), True, (255, 255, 255))
        consts.SMALLFONT.render_to(consts.SCREEN,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS) + 2 * consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR + 12 *consts.FACTOR,),"\U0001F4E9 " + consts.SKILLSGUI[self.packet[0]] + " " + str(self.packet[1:]) + "   |   \U000023F1: " + str(self.dt), (255, 255, 255))
        # text = consts.SMALLFONT.render("\U0001F4F6 " + str(self.QC1) + "% | " + str(self.ID) + "/128" + "  |  FPS: " + str(self.fps), True, (255, 255, 255))
        consts.SMALLFONT.render_to(consts.SCREEN,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS)+ 2 * consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR + 18 *consts.FACTOR,),"\U0001F4F6 " + str(self.QC1) + "% | " + str(self.ID) + "/128" + "  |  FPS: " + str(self.fps), (255, 255, 255))
        # text = consts.SMALLFONT.render(" Git \U00002601 : " + str(self.commit), True, (255, 255, 255))
        consts.SMALLFONT.render_to(consts.SCREEN,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS)+ 20 * consts.FACTOR+ 21*consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR + 18.4 *consts.FACTOR,)," Git \U00002601 : " + str(self.commit), (255, 255, 255))
        # text = consts.SMALLFONT.render(" CPU \U0001F532 :" + str(self.cpu) + "% \U0001F321: " + str(self.cpuTemp) + "ºC    |    GPU : " + str(self.gpu) + "% \U0001F321: " + str(self.gpuTemp) + "ºC", True, (255, 255, 255))
        consts.SMALLFONT.render_to(consts.SCREEN,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS)+ 2 * consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR + 24 *consts.FACTOR,)," CPU \U0001F532 :" + str(self.cpu) + "% \U0001F321: " + str(self.cpuTemp) + "ºC    |    GPU : " + str(self.gpu) + "% \U0001F321: " + str(self.gpuTemp) + "ºC", (255, 255, 255))
        
        # text = consts.SMALLFONT.render("OMNI - \U000023EB:" + str(self.linear_vel) + "  \U0001F504:" + str(self.angular_vel) + "  \U00002199:" + str(self.direction) + " \U0001F321: " + str(self.OMNI_temp) + "ºC", True, (255, 255, 255))
        consts.SMALLFONT.render_to(consts.SCREEN,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS)+ 2 * consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR + 30 *consts.FACTOR,),"OMNI - \U000023EB:" + str(self.linear_vel) + "  \U0001F504:" + str(self.angular_vel) + "  \U00002199:" + str(self.direction) + " \U0001F321: " + str(self.OMNI_temp) + "ºC", (255, 255, 255))
        # text = consts.SMALLFONT.render("Dribbler - \U00002197  " + str(self.disp_db_l) + "  v-> " + str(self.vel_db_l) + "  \U0001F94E  " + str(self.vel_db_l) + " <-v  " + str(self.disp_db_r) + "  \U00002196", True, (255, 255, 255))
        consts.SMALLFONT.render_to(consts.SCREEN,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS)+ 2 * consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR + 36 *consts.FACTOR,),"Dribbler - \U00002197  " + str(self.disp_db_l) + "  v-> " + str(self.vel_db_l) + "  \U0001F94E  " + str(self.vel_db_l) + " <-v  " + str(self.disp_db_r) + "  \U00002196", (255, 255, 255))
         
        # text = consts.SMALLFONT.render("\U0001F9BF\U0001F3C8: " + str(self.Cap) + " %", True, (255, 255, 255))
        consts.SMALLFONT.render_to(consts.SCREEN,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS)+ 2 * consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR + 42 *consts.FACTOR,),"\U0001F9BF\U0001F3C8: " + str(self.Cap) + " %", (255, 255, 255))
    ...
    def draw_robotInfo3(self, selectedRobot = 0):
        robotID = self.robotID - 1
        ...
        text = consts.SMALLFONT.render("Robot " + str(self.robotID), True, (255, 255, 255))
        consts.SCREEN.blit(text,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS) + 2 * consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR,),)

        if self.battery < 0:
            text = consts.SMALLFONT.render(str("NOT CON."), True, (255,255,255))
        else:
            text = consts.SMALLFONT.render(str(self.battery) + "%", True, (255,255,255))
        consts.SCREEN.blit(text,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS) + int(int(consts.RESOLUTION[0]/consts.NUMBER_OF_ROBOTS)/6) + 2 * consts.FACTOR, consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR,),)

        if self.battery12 < 0:
            text = consts.SMALLFONT.render(str("NOT CON."), True, cor)
        else:
            text = consts.SMALLFONT.render(str("")+str(self.battery12) + "%", True, (255,255,255))
        consts.SCREEN.blit(text,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS) + int(5*int(consts.RESOLUTION[0]/consts.NUMBER_OF_ROBOTS)/12), consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR,),)
            
        if self.pcbattery > 0:
            text = consts.SMALLFONT.render(""+ str(abs(self.pcbattery)) + "%" + "", True, (255,255,255))
        else:
            text = consts.SMALLFONT.render(""+ str(abs(self.pcbattery)) + "%", True, (255,255,255))
        consts.SCREEN.blit(text,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS) + int(7*int(consts.RESOLUTION[0]/consts.NUMBER_OF_ROBOTS)/10), consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR,),)

        text = consts.SMALLFONT.render("POS: " + str(round(self.position[0], 2)) + " " + str(round(self.position[1], 2)) + " " + str(self.position[2]), True, (255, 255, 255))
        consts.SCREEN.blit(text,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS) + 2 * consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR + 6 *consts.FACTOR,),)
        text = consts.SMALLFONT.render("BALL: " + str(round(self.ball_position[0], 2)) + " " + str(round(self.ball_position[1], 2)) + " " + str(self.ball_handler), True, (255, 255, 255))
        consts.SCREEN.blit(text,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS) + 35 * consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR + 6 *consts.FACTOR,),)
        text = consts.SMALLFONT.render("Packet: " + consts.SKILLSGUI[self.packet[0]] + " " + str(self.packet[1:]) + "   |   : " + str(self.dt), True, (255, 255, 255))
        consts.SCREEN.blit(text,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS) + 2 * consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR + 12 *consts.FACTOR,),)
        text = consts.SMALLFONT.render("QC: " + str(self.QC1) + "% | " + str(self.ID) + "/128" + "  |  FPS: " + str(self.fps), True, (255, 255, 255))
        consts.SCREEN.blit(text,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS)+ 2 * consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR + 18 *consts.FACTOR,),)
        text = consts.SMALLFONT.render(" Git : " + str(self.commit), True, (255, 255, 255))
        consts.SCREEN.blit(text,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS)+ 20 * consts.FACTOR+ 21*consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR + 18.4 *consts.FACTOR,),)
        text = consts.SMALLFONT.render(" CPU  :" + str(self.cpu) + "% : " + str(self.cpuTemp) + "ºC    |    GPU : " + str(self.gpu) + "% : " + str(self.gpuTemp) + "ºC", True, (255, 255, 255))
        consts.SCREEN.blit(text,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS)+ 2 * consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR + 24 *consts.FACTOR,),)
        
        text = consts.SMALLFONT.render("OMNI - " + str(self.linear_vel) + "  :" + str(self.angular_vel) + "  :" + str(self.direction) + " : " + str(self.OMNI_temp) + "ºC", True, (255, 255, 255))
        consts.SCREEN.blit(text,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS)+ 2 * consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR + 30 *consts.FACTOR,),)
        text = consts.SMALLFONT.render("Dribbler - " + str(self.disp_db_l) + "  v-> " + str(self.vel_db_l) + "    " + str(self.vel_db_l) + " <-v  " + str(self.disp_db_r) + "  ", True, (255, 255, 255))
        consts.SCREEN.blit(text,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS)+ 2 * consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR + 36 *consts.FACTOR,),)
         
        text = consts.SMALLFONT.render("CAP: " + str(self.Cap) + " %", True, (255, 255, 255))
        consts.SCREEN.blit(text,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS)+ 2 * consts.FACTOR,consts.FIELD_SIZE["wall"][1] + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR + 42 *consts.FACTOR,),)
