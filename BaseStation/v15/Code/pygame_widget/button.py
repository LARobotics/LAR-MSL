...
class Button(WidgetBase):
    def __init__(self, win, x, y, width, height, isSubWidget=False, **kwargs):
        ...
        self.font = kwargs.get('font', pygame.font.SysFont('segoeuiemoji', self.fontSize))
    ...
    def setText(self, string, Colour):
        self.text = self.font.render(string, True, Colour)
        self.textRect = self.text.get_rect()
...
def siga(button):
    print(1)
    button.inactiveColour = (255, 255, 255) 
...
if __name__ == '__main__':
    ...
    buttonArray = ButtonArray(win, 150, 150, 50, 50, (2, 2), border=1, texts=('1', '2', '3', '4'),
                              onClicks=(lambda: siga(button), lambda: print(2), lambda: print(3), lambda: print(4)))
