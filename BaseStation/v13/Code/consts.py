...
if platform.system() == "Windows":
    SCOREFONT = pygame.freetype.SysFont('ocraextended', int(30*(FACTOR_INT)))
    SCOREFONT2 = pygame.freetype.SysFont('ocraextended', int(10*(FACTOR_INT)))
    SMALLFONT = pygame.freetype.SysFont('segoeuiemoji', int(5*(FACTOR_INT)))
    SMALLFONT2 = pygame.freetype.SysFont('segoeuisymbol', int(5*(FACTOR_INT)))
    TINYFONT = pygame.freetype.SysFont('segoeuiemoji', int(3*(FACTOR_INT)))
    SUPERTINYFONT = pygame.freetype.SysFont('segoeuiemoji', int(2*(FACTOR_INT)))
else:
    SCOREFONT = pygame.freetype.SysFont('ocraextended', int(30*(FACTOR_INT)))
    SCOREFONT2 = pygame.freetype.SysFont('ocraextended', int(10*(FACTOR_INT)))
    SMALLFONT = pygame.freetype.SysFont('notocoloremoji', int(5*(FACTOR_INT)))
    SMALLFONT2 = pygame.freetype.SysFont('notocoloremoji', int(5*(FACTOR_INT)))
    TINYFONT = pygame.freetype.SysFont('notocoloremoji', int(3*(FACTOR_INT)))
    SUPERTINYFONT = pygame.freetype.SysFont('notocoloremoji', int(2*(FACTOR_INT)))
