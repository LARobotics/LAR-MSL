...
while initTime != -1:
    ...
    if Robots[1].ball_handler == 0 and kick == 0:
        Robots[1].packet = [ATTACK, Robots[0].ball_position[0], Robots[0].ball_position[1], 0, 0, 0, 0, 0]
    else:
        kick = 1
    ...
    Robots[1].packet = [COVER, Robots[0].position[0], Robots[0].position[1], Robots[0].ball_position[0], Robots[0].ball_position[1], 1, 0.5, 0]    
