...
class communication:
    def __init__(self, ROBOTID, Bport):
        Aport = 0
        self.SocketAdress2send = ("localhost", 30000+Bport*1000+Aport*100+ROBOTID*10+0)
        self.sendSocketAdress = ("localhost", 30000+Bport*1000+Aport*100+ROBOTID*10+1)
        self.recvSocketAdress = ("localhost", 30000+Aport*1000+Bport*100+ROBOTID*10+0)
    ...
    def getMessage(self, info):
        try:
            while True:
                try:
                    TempMessage = self.recvSocket.recvfrom(1024)
