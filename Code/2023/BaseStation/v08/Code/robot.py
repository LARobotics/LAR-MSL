...
class Robot:
    ...
    def draw_robotInfo(self, selectedRobot = 0):
        ...
        if self.battery > 12.2:
            pygame.draw.rect(consts.SCREEN,consts.COLORS["batGreen"],(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS) + 21 * consts.FACTOR, 167 * consts.FACTOR,int(consts.RESOLUTION[0] /consts.NUMBER_OF_ROBOTS) - 55*consts.FACTOR, 8 *consts.FACTOR,),border_radius=5,)
            pygame.draw.rect(consts.SCREEN,consts.COLORS["batGreen"],(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS) + 49 * consts.FACTOR, 167 * consts.FACTOR,int(consts.RESOLUTION[0] /consts.NUMBER_OF_ROBOTS) - 50*consts.FACTOR, 8 *consts.FACTOR,),border_radius=5,)
        elif self.battery > 11.9:
            pygame.draw.rect(consts.SCREEN,consts.COLORS["batYellow"],(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS) + 21 * consts.FACTOR, 167 * consts.FACTOR,int(consts.RESOLUTION[0] /consts.NUMBER_OF_ROBOTS) - 55*consts.FACTOR, 8 *consts.FACTOR,),border_radius=5,)
            pygame.draw.rect(consts.SCREEN,consts.COLORS["batYellow"],(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS) + 49 * consts.FACTOR, 167 * consts.FACTOR,int(consts.RESOLUTION[0] /consts.NUMBER_OF_ROBOTS) - 50*consts.FACTOR, 8 *consts.FACTOR,),border_radius=5,)
        else:
            pygame.draw.rect(consts.SCREEN,consts.COLORS["batRed"],(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS) + 21 * consts.FACTOR, 167 * consts.FACTOR,int(consts.RESOLUTION[0] /consts.NUMBER_OF_ROBOTS) - 55*consts.FACTOR, 8 *consts.FACTOR,),border_radius=5,)
            pygame.draw.rect(consts.SCREEN,consts.COLORS["batRed"],(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS) + 49 * consts.FACTOR, 167 * consts.FACTOR,int(consts.RESOLUTION[0] /consts.NUMBER_OF_ROBOTS) - 50*consts.FACTOR, 8 *consts.FACTOR,),border_radius=5,)
        text = consts.SMALLFONT.render("Bat: " + str(self.battery) + " V", True, (255, 255, 255))
        consts.SCREEN.blit(text,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS) + 22 * consts.FACTOR, 160 *consts.FACTOR + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR,),)
        text = consts.SMALLFONT.render("PCBat: " + str(self.pcBattery) + " V", True, (255, 255, 255))
        consts.SCREEN.blit(text,(robotID * int(consts.RESOLUTION[0] / consts.NUMBER_OF_ROBOTS) + 50 * consts.FACTOR, 160 *consts.FACTOR + consts.MENUS_SIZE * consts.RESOLUTION[1] + 2 *consts.FACTOR,),)
        text = consts.SMALLFONT.render("L: " + str(self.position[0]) + " " + str(self.position[1]) + " " + str(self.position[2]), True, (255, 255, 255))
        ...
        text = consts.SMALLFONT.render("| B: " + str(self.ball_position[0]) + " " + str(self.ball_position[1]) + " " + str(self.ball_position[2]), True, (255, 255, 255))
        ...
        text = consts.SMALLFONT.render("Coms: " + consts.SKILLSGUI[self.packet[0]] + " " + str(self.packet[1:]), True, (255, 255, 255))
...
def getInfo(Robots):
    ...
    for robot in Robots:
        try:
            ...
            robot.position[0] = round(robot.position[0]/(1000/(consts.FIELD_DIMENSIONS["A"]/20)), 2)
            robot.position[1] = round(robot.position[1]/(1000/(consts.FIELD_DIMENSIONS["B"]/20)), 2)
            ...
            robot.ball_position[0] = round(robot.ball_position[0]/(1000/(consts.FIELD_DIMENSIONS["A"]/20)), 2)
            robot.ball_position[1] = round(robot.ball_position[1]/(1000/(consts.FIELD_DIMENSIONS["B"]/20)), 2)
            ...
            if robot.info[4] != "":
                ...
                for r in range(len(robot.otherRobots)):
                    robot.otherRobots[r][0] = round(robot.otherRobots[r][0]/(1000/(consts.FIELD_DIMENSIONS["A"]/20)), 2)
                    robot.otherRobots[r][1] = round(robot.otherRobots[r][1]/(1000/(consts.FIELD_DIMENSIONS["B"]/20)), 2)
            else:
                robot.otherRobots = []
            a = 1
        except:
