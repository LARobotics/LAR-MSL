...
calibSkillStrings = [
                     ...
                     ["A", "B", "place_Katracao", "place_Kintensidade", "place_outputLimit", "defend_Katracao", "defend_Kintensidade", "defend_outputLimit", "TM threshold"],#                     ["Kp_defend","Ki_defend","Kd_defend","outputLimit_PID_defend","Katracao_defend","Kintensidade_defend","outputLimit_atractor_defend",],
