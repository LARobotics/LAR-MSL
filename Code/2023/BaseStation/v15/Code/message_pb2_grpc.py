...
class Yolo_OmniStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.Send_Omni = channel.unary_unary(
...
def add_Yolo_OmniServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Send_Omni': grpc.unary_unary_rpc_method_handler(
                    servicer.Send_Omni,
...
class Yolo_Omni(object):
    ...
    def Send_Omni(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pb.Yolo_Omni/Send_Omni',
