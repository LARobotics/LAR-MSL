...
def ProbFields(): 
    if REPRESENT_GAME:
        ...
        for robot in Robots[1:]:
            guiElements.drawLine(robot.position, robot.moveTo, color=consts.COLORS["green"], width=2)
...
def getIPS():
    ...
    defaultIPS = ["172.16.49.249", "172.16.49.253", "172.16.49.124", "172.16.49.13", "172.16.49.225", "172.16.49.225"]
    IPS = []
...
def main():
    ...
    match refBox.state:
        ...
        case 2:             #POSITIONING
            Robots = positionRobotsRefBox(refBox.CommandID, refBox.Arg, Robots)
