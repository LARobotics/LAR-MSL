...
def drawLine(P1, P2, text="", color = consts.COLORS["blue"], width = 1):
    ...
    """
    location1 = guiFuncs.coord2FieldCoord(P1[0], P1[1])
    location2 = guiFuncs.coord2FieldCoord(P2[0], P2[1])
    ...
    if text != "":
        string = consts.SMALLFONT.render(str(text), True, (255, 0, 0))#(255*(1-float(text)), 0, 255*(float(text))))
        ...
        consts.SCREEN.blit(string,(midLocation[0]-size[0], midLocation[1]-size[1]))
