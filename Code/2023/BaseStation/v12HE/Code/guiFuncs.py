    ...
    if justInfo == 0:
        for index, robot in enumerate(Robots):
            ...
            if index == selectedRobot:
                robot.draw_robot(1)
                robot.draw_robotInfo4(1)
            else:
                robot.draw_robot()
                robot.draw_robotInfo4()
        # Robots[0].draw_robotInfo1(Robots)
...
def handleMarkers(mouse, skillsMarker, mouseGUI, Robots, selectedRobot):
    ...
    consts.TINYFONT.render_to(consts.SCREEN, (mouseGUI[selectedRobot][1][0] - rect.width / 2, mouseGUI[selectedRobot][1][1] - rect.height / 2), "T2", (255, 255, 255))
    ...
    text, rect = consts.TINYFONT.render("T1", (255, 255, 255))
    consts.TINYFONT.render_to(consts.SCREEN, (mouseGUI[selectedRobot][0][0] - rect.width / 2, mouseGUI[selectedRobot][0][1] - rect.height / 2), "T1", (255, 255, 255))
