...
skillWidgets.append(Button(SCREEN, int(consts.FACTOR + consts.FIELD_SIZE["wall"][0]+(consts.RESOLUTION[0]-int(consts.FIELD_SIZE["wall"][0]))),
...
if REPRESENT and runMode:
    ...
    ############ MENU TABS ############
    MenuSelected = 0
    MainMenus = [["Game + RefBox", "Control", "Prob Fields", "Skills", "Calibration", "Exit"],[0, 0, 0, 0, 0, 0],[],[Game, Control, ProbFields, Skills, Calibration, Exit], [gameWidgets, controlWidgets, [], skillWidgets, [], []]]
