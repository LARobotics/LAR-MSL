...
def plot_transition(polar1, polar2, num_frames=100, DAMP = 8):
    ...
    for i in range(1, num_frames):
        ...
        polar_interpolated = dampening_transition_polar(polar_interpolated, polar2, alpha, DAMP)
        x, y = polar_to_cartesian(*polar_interpolated)
        ax.plot([0, x], [0, y], color='blue')
        ax.plot(x, y, marker='o', color='red')
        x, y = polar_to_cartesian(*polar1)
        ax.plot(x, y, marker='o', color='green')
        ax.plot([0, x], [0, y], color='green')
        x, y = polar_to_cartesian(*polar2)
        ax.plot(x, y, marker='o', color='yellow')
        ax.plot([0, x], [0, y], color='yellow')
...
while 1:
    polar1 = (100, np.deg2rad(0))  # rho, theta
    polar2 = (100, np.deg2rad(179))  # rho, theta
